        ...
        if (e.shiftKey) {
            if (itemInventory === "second") {
                if (type === "trunk") {
                    ...
                    $.post("https://esx_inventoryhud/TakeFromGudang", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "player") {
                ...
                if (type === "trunk") {
                    ...
                    $.post("https://esx_inventoryhud/PutIntoGudang", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "player") {
    ...
    $('#playerInventory').droppable({
        drop: function(event, ui) {
            ...
            if (type === "trunk" && itemInventory === "second") {
                ...
                $.post("http://esx_inventoryhud/TakeFromGudang", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
